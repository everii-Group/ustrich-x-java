...
public class ReportXmlParser extends DefaultHandler implements ReportParser {
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		//End of filter
		if (qName.equalsIgnoreCase("filter")) {
			String aname = element_atts.getValue("name");
			String atitle = element_atts.getValue("title");
		...
		if (within_row) {
			if (qName.equalsIgnoreCase("cell") || qName.equalsIgnoreCase("addi:cell")) {
				//Set cell value
				String aname = element_atts.getValue("name");
				String atype = element_atts.getValue("type");
				...
				switch (ftype) {
					...
					case number2:
					case currency:
						value = element_atts.getValue("usnumber");
						type = "number";
						break;
					case bool:
						break;
					case date:
						value = element_atts.getValue("usdate");
						real = element_atts.getValue("xlsdate");
						type = "xlsdate";
						break;
					case time:
						value = element_atts.getValue("usdate");
